...
async def unread_count(identity: ClientIdentity = Depends(require_wechat_bound_client)) -> UnreadCountResponse:
...
async def list_likes(identity: ClientIdentity = Depends(require_wechat_bound_client)) -> MessageListResponse:
...
async def list_saved(identity: ClientIdentity = Depends(require_wechat_bound_client)) -> MessageListResponse:
